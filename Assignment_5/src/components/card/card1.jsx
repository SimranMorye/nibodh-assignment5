  ...
  return (
    <div>
      <div className="row card-1-custom-con">
        ...
        <div className="col-6" style={{ backgroundColor: "#67adb4" }}>
          <div className="row">
            ...
            <div className="col-12">
              <p className="text-white text-center">
                ...
                nesciunt hic aliquid mollitia quo. Dolore, amet eius sapiente
                repellat magnam tempore qui, sit totam maiores laudantium quos
                molestiae quas nesciunt?
              </p>
            </div>
